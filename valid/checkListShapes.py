...
def list_vtk_files(dir):
    ...
    return sorted([os.path.splitext(f)[0] for f in vtk_files], key=lambda s: s.lower())
...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 6:
        print("Usage: ./check.py <mcts program> <test case directory> <param.json> <out directory> <filter.json>")
    else:
        ...
        if input_files:
            ...
            print("No matching files in the specified directory.")

#./check.py ./my_program ./shapes ./params.json ./results ./filter.json